package com.example.lesson6android1.ui.activitis;
...
import com.example.lesson6android1.R;
import com.example.lesson6android1.databinding.ActivitySecondBinding;
...
public class SecondActivity extends AppCompatActivity {
    ...
    private void getData() {
        ...
        String quiz = arguments.getStringExtra("dog");
        ...
        binding.btnOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (arguments.getStringExtra("dog") == arguments.getStringExtra("dog")) {
                    ...
                    new CountDownTimer(3000, 1000) {
                        ...
                        public void onFinish() {
                            ...
                            binding.btnOne.setText(arguments.getStringExtra("up"));
                        }
                    }.start();
                }
            }
        ...
        binding.btnTwo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (arguments.getStringExtra("dog") == arguments.getStringExtra("up")) {
                    Toast.makeText(SecondActivity.this, "правильно", Toast.LENGTH_SHORT).show();
                } else {
        ...
        binding.btnTree.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (arguments.getStringExtra("dog") == arguments.getStringExtra("l")) {
                    Toast.makeText(SecondActivity.this, "правильно", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(SecondActivity.this, "Не правильно", Toast.LENGTH_SHORT).show();
        ...
        binding.btnFour.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (arguments.getStringExtra("dog") == arguments.getStringExtra("a")) {
                    Toast.makeText(SecondActivity.this, "правильно", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(SecondActivity.this, "Не правильно", Toast.LENGTH_SHORT).show();
