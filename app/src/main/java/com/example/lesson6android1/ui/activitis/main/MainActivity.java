package com.example.lesson6android1.ui.activitis.main;
...
import com.example.lesson6android1.ui.activitis.SecondActivity;
import com.example.lesson6android1.ui.activitis.main.adapter.GameAdapter;
import com.example.lesson6android1.сlient.GameClient;
import com.example.lesson6android1.data.GameModel;
import com.example.lesson6android1.databinding.ActivityMainBinding;
import com.example.lesson6android1.interfaces.OnItemClickListener;
    ...
    private void listeners() {
        gameAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void OnItemClick(int position, GameModel gameModel) {
                ...
                intent.putExtra("dog",gameModel.getQuiz());
